...
export default function Services() {
  ...
  const values = [
    ...
    { title: 'Precision Planning', text: 'Detailed scheduling keeps the project timeline synchronized and prevents costly engineering delays.', icon: Compass }
  ];
          ...
          {values.map((v, idx) => {
            ...
            return (
              <div key={idx} className="glass-panel p-6 rounded-2xl space-y-3">
                ...
                <p className="text-xs text-slate-400 leading-relaxed font-light">{v.text}</p>
              </div>
            );
          })}
        </div>
